...
export default function Experience() {
  return (
    <div className="min-h-screen bg-gradient-to-br from-slate-50 to-blue-50">
      ...
      <div className="flex flex-col items-center justify-center px-8 pt-20 pb-8 sm:px-16">
        <Header name="My Experiences" className="text-black" />
        <div className="flex flex-col items-center justify-center gap-y-16">
          {internships.map((internship) => (
            ...
            >
              <div className="flex-shrink-0 w-full h-48 overflow-hidden sm:w-72 sm:h-48 rounded-xl">
                <Image
                  src={internship.Image}
                  alt={internship.company}
                  width={288}
                  height={192}
                  className="object-cover w-full h-full transition-all duration-300 shadow-md rounded-xl group-hover:shadow-lg"
                />
              </div>
              <div className="flex flex-col items-start justify-center sm:px-8">
                <h2 className="pt-4 text-2xl font-bold transition-colors duration-300 sm:text-3xl text-slate-800 sm:pt-0 group-hover:text-blue-600">
                  {internship.company}
                </h2>
                <h3 className="mt-1 text-lg font-semibold text-blue-600 sm:text-xl">
                  {internship.position}
                </h3>
                <div className="flex items-center mt-2 mb-4">
                  <span className="inline-block w-2 h-2 mr-2 bg-green-500 rounded-full"></span>
                  <p className="text-sm font-medium sm:text-base text-slate-600">
                ...
                <div className="space-y-2">
                  {internship.description.map((desc) => (
                    <li
                      key=""
                      className="flex items-start leading-relaxed text-justify text-slate-700"
                    >
                ...
                <div className="inline-flex items-center px-4 py-2 mt-6 text-sm font-medium text-blue-700 transition-all duration-200 rounded-lg bg-blue-50 hover:bg-blue-100 hover:shadow-md">
                  <a
